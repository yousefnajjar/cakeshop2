    ...
    return (
      <main className="container mx-auto py-20 px-4 text-center">
        <div className="max-w-md mx-auto">
          ...
          <h1 className="text-3xl font-bold mb-4">Oops! Cake Not Found</h1>
    ...
    <main className="container mx-auto py-8 px-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-16">
        ...
        <div className="space-y-8">
          <div>
            <h1 className="text-4xl lg:text-5xl font-bold mb-4 text-gray-800">{cake.name}</h1>
            <div className="flex items-center space-x-4 mb-6">
              <p className="text-3xl lg:text-4xl font-bold text-primary">{cake.price}</p>
      ...
      {relatedCakes.length > 0 && (
        <section className="mb-16">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600">More delicious options to satisfy your sweet tooth</p>
          </div>
            ...
            {relatedCakes.map((relatedCake, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-xl font-bold text-primary">{relatedCake.price}</p>
                </div>
              </Link>
            ))}
          </div>
